         ...
         <aside className="fixed inset-y-0 left-0 hidden w-14 flex-col border-r bg-background sm:flex z-50">
            <nav className="flex flex-col items-center gap-4 px-2 sm:py-5">
               ...
               <TooltipProvider>
                  <Tooltip>
                     <TooltipTrigger>
                        <Link className={`flex h-9 w-9 items-center justify-content rounded-lg  
                        ${active === "Dashboard" ? "text-accent-foreground bg-accent " : "text-muted-foreground"}
               ...
               <TooltipProvider>
                  <Tooltip>
                     <TooltipTrigger>
                        <Link className={`flex h-9 w-9 items-center justify-content rounded-lg 
                        ${active === "Add Project" ? "text-accent-foreground bg-accent " : "text-muted-foreground"}
                        transition-colors hover:text-foreground focus:outline-none md:h-8 md:w-8 `}
               ...
               <TooltipProvider>
                  <Tooltip>
                     <TooltipTrigger>
                        <Link className={`flex h-9 w-9 items-center justify-content rounded-lg 
                        ${active === "Add Skills" ? "text-accent-foreground bg-accent " : "text-muted-foreground"}
                        transition-colors hover:text-foreground md:h-8 md:w-8 `}
               ...
               <TooltipProvider>
                  <Tooltip>
                     <TooltipTrigger>
                        <Link className={`flex h-9 w-9 items-center justify-content rounded-lg 
                        ${active === "Add Application" ? "text-accent-foreground bg-accent " : "text-muted-foreground"}
                        transition-colors hover:text-foreground md:h-8 md:w-8 `}
               ...
               <TooltipProvider>
                  <Tooltip>
                     <TooltipTrigger>
                        <Link className={`flex h-9 w-9 items-center justify-content rounded-lg 
                        ${active === "Add Timeline" ? "text-accent-foreground bg-accent " : "text-muted-foreground"}
                        transition-colors hover:text-foreground md:h-8 md:w-8 `}
               ...
               <TooltipProvider>
                  <Tooltip>
                     <TooltipTrigger>
                        <Link className={`flex h-9 w-9 items-center justify-content rounded-lg 
                        ${active === "Messages" ? "text-accent-foreground bg-accent " : "text-muted-foreground"}
                        transition-colors hover:text-foreground md:h-8 md:w-8 `}
               ...
               <TooltipProvider>
                  <Tooltip>
                     <TooltipTrigger>
                        <Link className={`flex h-9 w-9 items-center justify-content rounded-lg 
                        ${active === "Account" ? "text-accent-foreground bg-accent " : "text-muted-foreground"}
                        transition-colors hover:text-foreground md:h-8 md:w-8 `}
            ...
            <TooltipProvider>
                  <Tooltip>
                     <TooltipTrigger>
                        <Link className={`flex h-9 w-9 items-center justify-content rounded-lg 
                        ${active === "Logout" ? "text-accent-foreground bg-accent " : "text-muted-foreground"}
                        transition-colors hover:text-foreground md:h-8 md:w-8 `}
            ...
            <Sheet>
               ...
               <SheetContent side="left" className="sm:max-w-xs">
                  <nav className="grid gap-6 text-lg font-medium">
                     <Link className="group flex h-10 w-10 shrink-0 items-center justify-center gap-2 rounded-full
                     bg-primary-foreground text-lg font-semibold text-primary-foreground md:text-base"
                     >
                     ...
                     <div className="flex w-full items-center gap-4 md:grow-0 sm:ml-16 sm:mt-5">
                        <img src={user && user.avatar && user.avatar.url} 
                        alt="avatar" 
                        className="w-20 h-20 rounded-full max-[900px]:hidden"
                        />
                        <h1 className="text-4xl max-[900pcx:text-2xl">
